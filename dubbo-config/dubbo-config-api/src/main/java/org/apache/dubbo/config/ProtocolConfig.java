...
public class ProtocolConfig extends AbstractConfig {
    ...
    public String getNickHost() {
        return nickHost;
    }

    public void setNickHost(String nickHost) {
        this.nickHost = nickHost;
    }

    public Integer getNickPort() {
        return nickPort;
    }

    public void setNickPort(Integer nickPort) {
        this.nickPort = nickPort;
    }
