    ...
    class MonitorListener implements Listener {
        ...
        private void collect(Invoker<?> invoker, Invocation invocation, Result result, String remoteHost, long start, boolean error) {
            try {
                ...
                if(null!=temUrl.getParameter("side")&&temUrl.getParameter("side").equals("provider")) {
                    statisticsURL = statisticsURL.setHost(temUrl.getHost());
                } else {
                    if(Boolean.valueOf(temUrl.getParameters().get("internal"))){
                        statisticsURL = statisticsURL.addParameter("provider", temUrl.getParameters().get("nick.host")+
                                ":" +
                                temUrl.getParameters().get("nick.port"));
                    }
                    statisticsURL = statisticsURL.setHost(temUrl.getParameter("register.ip"));
                }
