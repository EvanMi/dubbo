...
class URL implements Serializable {
    ...
    public URL getUrlParameter(String key) {
        ...
        if(key.equals(MONITOR_KEY)) {
            if(null!=getParameter("side")
                    &&getParameter("side").equals("provider")){
                value += "&register.ip=" + this.host;
            } else {
                value += "&register.ip=" + getParameter("register.ip");
            }
